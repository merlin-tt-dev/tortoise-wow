...
class GameObject : public WorldObject
{
    ...
    protected:
        ...
        ObjectGuidSet m_SkillupSet;                         // players that already have skill-up at GO use
        ...
        ObjectGuidSet m_allowedLooters;                     // if not empty only those players are allowed to use the gameobject
