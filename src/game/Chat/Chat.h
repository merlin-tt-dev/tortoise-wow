...
class ChatHandler
{
    public:
        ...
        **/
        static void BuildChatPacket(
            WorldPacket& data, ChatMsg msgtype, std::string_view message, Language language = LANG_UNIVERSAL, uint32 chatTag = CHAT_TAG_NONE,
    ...
    protected:
        ...
        bool HandleGameObjectSetSpawnFlagsCommand(char* args);
        bool HandleGameObjectSetVisibilityCommand(char* args);
